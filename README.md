...
Want to watch a movie with your family but worried about explicit content? CensorSnip might be your solution!
...
pip install git+https://github.com/moabu/CensorSnip.git
```
Download the pretrained checkpoint provided by the author.
```
from CensorSnip import run_inference
run_inference.run(path_model='pretrained_models/best_21_Feb_2024.pt',
                path_results='test_inference/',
                path_input='/input/video.mp4',
                class_confidence_dict=[0.8,0.8,0.8,0.8,0.8],
                do_trimming=True,
                start_time='0:0:20',
                duration='0:0:30',
                pred_batch=256,
...
*Make sure to have at least one of the four flags raised to visualize the results.*
